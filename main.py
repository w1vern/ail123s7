...
class Thread(QThread):
    ...
    def __init__(self, parent=None):
        ...
        self.face_cascade_file = os.path.join(cv2.data.haarcascades, 'haarcascade_frontalface_default.xml')
        self.eye_cascade_file = os.path.join(cv2.data.haarcascades, 'haarcascade_eye.xml')
        self.status = True
        self.cap = None
